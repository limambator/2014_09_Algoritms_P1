...
public class MaxPQ<Key> implements Iterable<Key> {
	...
	public static void main(String[] args) {
		 ...
		 * (!item.equals("-")) pq.insert(item); else if (!pq.isEmpty())
		 * StdOut.print(pq.delMax() + " "); } StdOut.println("(" + pq.size() +
		 * " left on pq)");
		 */
		
		/*String[] a = { "72", "93", "87", "71", "68", "60", "78", "32", "58",
				"11" };
		...
		String[] a = { "99", "88", "95", "30", "57", "22", "60", "19", "29", "42" };
		for (int i = 0; i < a.length; i++) {
			pq.insert(a[i]);
		}
